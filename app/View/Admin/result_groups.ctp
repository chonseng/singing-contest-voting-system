...
<div class="row">
	<h2>結果(每人票數為<?=$_SESSION["groups_voting_amount"]?>的選票結果)</h2>	
	<table width="100%">
		<thead>
			<tr>
	...
	<a href="<?php $this->Path->myroot(); ?>admin/deleteall_groups/<?=$_SESSION["groups_voting_amount"]?>" class="button big alert confirm">刪除所有每人票數為<?=$_SESSION["groups_voting_amount"]?>的選票</a>
